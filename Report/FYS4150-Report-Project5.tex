...
Fig.~\ref{fig:Nbody_energy}a-c shows that the kinetic energy rises quickly in the beginning, then stabilizing around $t = \tau_{\mathrm{crunch}}$. The overall kinetic energy decreases for larger values of $N$. This corresponds to what we saw in the scatter plots in Fig.~\ref{fig:N_body_simulation}a-i where the collection of stars appear to be more tightly bound for higher values of $N$, corresponding with an increasing potential energy.  
