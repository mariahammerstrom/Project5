...
\end{center}
\end{figure*}
When choosing the final time to be $t = 10\,000$, however, the VV method proved to be the most stable one. After a while the star that went through the RK4 method was ejected. See fig... Thus, for very large times, one should choose VV.
